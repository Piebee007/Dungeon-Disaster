    ...
    while quiz_loop == True:
        ...
        if mouse[0] > answer1_hitbox[0] and mouse[0] < answer1_hitbox[0] + answer1_hitbox[2]:
            if mouse[1] > answer1_hitbox[1] and mouse[1] < answer1_hitbox[1] + answer1_hitbox[3]:
                ...
                if click[0] == 1:
                    print(questions[(questions_to_be_selected[question_num])][5])
                    time.sleep(1)
                    if questions[(questions_to_be_selected[question_num])][1] == questions[(questions_to_be_selected[question_num])][4]:
                        ...
                        if questions[(questions_to_be_selected[question_num])][5] == "E":
                            score_gained += 50
                            print("Score Gained: ",score_gained)
                            #print("Health Gained: ",health_gained)
                            #print("Damage Multiplier Increase: ",damage_multiplier)
                            if question_num < 4:
                                question_num += 1
...
def redraw_quiz_window():
    ...
    elif (questions[(questions_to_be_selected[question_num])][5]) == "H":
