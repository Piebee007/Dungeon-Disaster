...
class Player (ParentObject):
    ...
    def __init__(self, x_pos, y_pos,health,weapon,damage_mult,map_num, image_array,ID):
        self.score = 0
        ...
        self.image_array = ""
        self.online_bullet_array = []
        self.online_enemy_array = []
    ...
    def shoot(self,mouse,click, soundEffects):
        ...
        if click[0] == 1 and self.ammo > 0 and (self.previous_click + weapon_data[self.weapon][0]) < time.time():
            ...
            if mouse[0] > self.x_pos - 20 and mouse[0] < self.x_pos + self.width + 10 and mouse[1] < self.y_pos +20:#Up
                ...
                self.online_bullet_array.append([round(self.x_pos + self.width // 2), (round(self.y_pos + self.height//2)-35), mouse[0], mouse[1]])
                ...
                self.online_bullet_array.append([(round(self.x_pos + self.width // 2)+35), round(self.y_pos + self.height//2), mouse[0], mouse[1]])
    ...
    def delete_item (self,index):
        ...
        del self.online_bullet_array[index]



class Enemy(ParentObject):

    def __init__(self,x_pos, y_pos,health,weapon,damage_mult,image_array,enemy_type,target):
